...
this package. For IUI 2026 submissions in this repository, we use the
`acmart` class with `sigconf,review,anonymous` options in `main.tex`.
Build with `latexmk -pdf main.tex` on TeX Live 2023+.
